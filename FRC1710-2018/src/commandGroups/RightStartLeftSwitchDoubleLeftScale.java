...
public class RightStartLeftSwitchDoubleLeftScale extends CommandGroup {
    ...
    public RightStartLeftSwitchDoubleLeftScale() {
    	...
    	addSequential(new DriveToPosition(170, .75, true,-1,false,false));
    	addSequential(new DriveToPosition(220, .6, true,-85,false,false));
    	addSequential(new DriveToPosition(30, .6, true,0,true,false));
    	addParallel(new ChangeLiftSetpoint(Constants.scaleHigh, 500));
    	addSequential(new DriveToPosition(30, .3, true,30,false,false));
    	...
    	addSequential(new DriveToPosition(20, .5, true,-135,true,false,true));
    	...
    	addSequential(new TrackCube(true));
    	addSequential(new DriveToPosition(15, .3, true,-180,true,false,true));
    	addSequential(new RunIntake(false));
